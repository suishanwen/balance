...
if __name__ == '__main__':
    ...
    for symbol in symbols:
        ...
        if _type == 'transaction':
            threading.Thread(target=Token2.__main__, args=(Client.OkexClient(), symbol,)).start()
        else:
            threading.Thread(target=Token1.__main__, args=(Client.OkexClient(), symbol,)).start()
